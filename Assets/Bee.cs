...
public class Bee : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 offset = new Vector3(0, -2f);
    ...
    void FixedUpdate()
    {
        ...
        {
            toggle = false;
            Instantiate(beebullet, gameObject.transform.position + offset, Quaternion.identity);
            Invoke("Timer", 0.5f);
    ...
    {
        RaycastHit2D Ray = Physics2D.Raycast(HitRay.position, Vector2.down, rayDistance, Player);
